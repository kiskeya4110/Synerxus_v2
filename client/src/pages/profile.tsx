...
export default function Profile() {
  ...
  // volunteerData contains { user, volunteerProfile } from /api/intake/volunteer-profile endpoint
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <Link href="/calendar">
              <Card className="cursor-pointer hover:border-primary/50 transition-colors" data-testid="card-total-hours">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Confirmed Hours</CardTitle>
