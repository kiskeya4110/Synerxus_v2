...
Do not claim or imply that Synerxus:

- establishes causal impact evidence
- guarantees regulatory compliance
- has auditor approval or certification
- certifies CSRD compliance
- provides formal assurance
- verifies beneficiaries *(unless independently verified by a third party)*
- provides an immutable audit trail *(unless technically implemented and documented)*
