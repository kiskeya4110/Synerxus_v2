            ...
            >
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="mt-3 w-full py-2 px-3 bg-white/40 hover:bg-white/60 rounded-lg text-emerald-700 text-sm font-medium transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
