    ...
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, overflowY: 'auto', overflowX: 'hidden', backgroundColor: '#f9fafb', zIndex: 100 }} data-testid="organization-dashboard">
      ...
      <main style={{ maxWidth: '1400px', margin: '0 auto', padding: isMobile ? '16px 24px 140px 24px' : '16px 24px' }} className="md:p-6">
        ...
        <div className="hidden md:grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '24px' }}>
          ...
          {/* Impact Metrics Card - Interactive - Shows AIU terminology when enabled, Impact Score when in shadow mode */}
          <div
            style={{
              backgroundColor: 'white',
              borderRadius: '12px',
          ...
          >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
              {/* Total Impact Score - Combined organization + volunteer */}
              <button
                onClick={() => setActiveModal('aiu')}
              ...
              {/* Volunteer Impact Score - Sum from all volunteers */}
              <button
                onClick={() => navigate('/volunteers')}
