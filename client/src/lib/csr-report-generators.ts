...
function buildVerifiedEvidenceSummaryPdf(context: VerifiedSummaryContext): string {
  ...
  const organizationScopeValue = context.partnersIncluded.length > 0
    ? context.partnersIncluded.map((name) => escapeHtml(name)).join("<br>")
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box} body{margin:0;background:#E5E7EB;color:var(--ink);font-family:Inter,Arial,sans-serif;-webkit-print-color-adjust:exact;print-color-adjust:exact}
    ...
    h1{margin:0;color:var(--navy);font-size:33px;letter-spacing:0} h2{margin:0 0 4px;color:var(--navy);font-size:22px;letter-spacing:0;page-break-after:avoid;break-after:avoid} h3{margin:0 0 9px;color:var(--navy);font-size:13px;page-break-after:avoid;break-after:avoid} p{font-size:11px;line-height:1.55;color:#475569;margin:0 0 10px}
    ...
    .card,.metric-card{border:1px solid var(--line);border-radius:8px;background:#fff;padding:13px;box-shadow:0 1px 2px rgba(15,23,42,.04);page-break-inside:avoid;break-inside:avoid}.soft{background:var(--soft)}.boundary{border-color:#F6D58B;background:#FFFBEB;color:#78350F}
    ...
    .tier-card{border:1px solid var(--line);border-radius:8px;padding:14px;background:#fff;page-break-inside:avoid;break-inside:avoid}.tier-card.green{border-top:3px solid var(--green)}.tier-card.amber{border-top:3px solid var(--amber)}.tier-card.navy{border-top:3px solid var(--navy)}
    ...
    @media print{body{background:#fff}.report-page{margin:0;border:0;width:8.5in;min-height:11in}@page{size:letter;margin:0}h2{page-break-after:avoid!important;break-after:avoid!important}h3{page-break-after:avoid!important;break-after:avoid!important}.card,.metric-card,.tier-card{page-break-inside:avoid!important;break-inside:avoid!important}}
  </style>
</head>
<body>
