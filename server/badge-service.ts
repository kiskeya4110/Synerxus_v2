...
const DEFAULT_BADGES: InsertBadge[] = [
  ...
  {
    name: "Impact Starter",
    description: "Logged your first partner-confirmed output",
    icon: "🌱",
    category: "volunteer",
    tier: "bronze",
    condition: "Log 1 partner-confirmed output",
  ...
  {
    name: "Impact Maker",
    description: "Recorded 10 partner-confirmed outputs",
    icon: "📊",
    category: "volunteer",
    tier: "silver",
    condition: "Log 10 partner-confirmed outputs",
    thresholdType: "impacts",
    thresholdValue: 10,
    displayOrder: 6,
    isActive: true,
  },
  {
    ...
    description: "Recorded 50+ partner-confirmed outputs",
    icon: "⭐",
    category: "volunteer",
    tier: "gold",
    condition: "Log 50 partner-confirmed outputs",
    thresholdType: "impacts",
    thresholdValue: 50,
    displayOrder: 7,
    isActive: true,
