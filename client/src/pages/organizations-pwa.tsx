...
export default function OrganizationsPWA() {
  ...
  return (
    <div className="pwa-shell flex flex-col bg-gradient-to-b from-slate-50 to-white">
      {/* PWA Header */}
      {renderHeader()}
      ...
      {/* Main Content */}
      <div className="pwa-scroll pb-20">
        {/* Page Title */}
        <div className="px-4 pt-4 pb-2 pwa-compact-x">
        ...
        {/* Search */}
        <div className="px-4 py-2 sticky top-0 bg-gradient-to-b from-slate-50 to-transparent z-10 pwa-compact-x">
