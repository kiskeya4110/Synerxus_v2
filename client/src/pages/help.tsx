...
import { Search, Book, MessageCircle, FileText, Users, Building2, Briefcase, HelpCircle, ChevronDown, ChevronRight, ExternalLink, Mail, Phone, Home, FolderOpen } from "lucide-react";
...
const faqData: FAQItem[] = [
  {
    ...
    answer: "Click the 'Sign Up' button on the landing page and choose your account type: Volunteer, Organization, or Corporate Partner. Fill in your details and verify your email to get started."
  },
  {
    category: "Getting Started",
    question: "What are the different user types?",
    answer: "Synerxus supports three user types: Volunteers (individuals looking to contribute), Organizations (non-profits managing projects), and Corporate Partners (companies managing CSR programs and employee volunteering)."
  },
  {
    category: "Volunteers",
    question: "How do I find volunteer opportunities?",
    answer: "Navigate to the 'Discover Opportunities' section from your dashboard. You can filter by location, skills, SDG goals, and availability to find the perfect match."
  },
  {
    category: "Volunteers",
    question: "How do I log my volunteer hours?",
    answer: "Go to 'Log Activity' from your dashboard. Select the project, enter the hours worked, describe what you accomplished, and submit for verification."
  },
  {
  ...
  },
  {
    ...
    answer: "Access your project details to view assigned volunteers, review applications, and track progress. You can communicate with volunteers through the messaging system."
  },
  {
  ...
  },
  {
    ...
    answer: "The Sustainable Development Goals (SDGs) are 17 global goals adopted by the United Nations. Synerxus maps all volunteer activities to these goals to measure and report impact."
  },
  {
    category: "SDG Goals",
    question: "How is my impact aligned to SDGs?",
    answer: "When projects are created, they're mapped to relevant SDGs. Your volunteer hours and contributions are automatically tracked against these goals for comprehensive impact reporting."
  }
];
  ...
  const helpContent = (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => setSelectedCategory("Getting Started")}>
