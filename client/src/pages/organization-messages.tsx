...
export default function OrganizationMessages() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `/api/organizations/${organizationId}/volunteers`,
      );
      if (!response.ok) {
  ...
  const handleStartConversation = () => {
    if (!newVolunteerId || !newTopic.trim() || !newMessage.trim()) {
      toast({
        ...
        description:
          "Please select a volunteer, enter a topic, and write a message",
        variant: "destructive",
      });
      return;
    }
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Communicate with volunteers on your projects
            </p>
          </div>
                  ...
                  {loadingVolunteers ? (
                    ...
                    <div className="w-full mt-1 px-3 py-2 border rounded-md bg-yellow-50 text-yellow-700 text-sm">
                      <p className="font-medium">
                        No volunteers assigned to projects
                      </p>
                      <p className="text-xs mt-1">
                        Volunteers need to be assigned to your projects
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="max-h-96 overflow-y-auto">
                {loadingThreads ? (
                  ...
                  <div className="p-4 text-center text-gray-500">
                    ...
                    <p className="text-sm">
                      Start a new conversation to connect with volunteers
                    </p>
                  </div>
                ) : (
          ...
          <Card className="lg:col-span-2">
            {selectedThread ? (
                ...
                <CardContent className="flex-1 overflow-y-auto p-4">
                  {loadingMessages ? (
                    ...
                    <div className="space-y-4">
                      {(threadMessages?.messages || []).map(
                        (msg: Message) => {
                          const isOwnMessage =
                            msg.senderId === parseInt(userId || "0");
                          return (
                            <div
                              key={msg.id}
              ...
              <div className="h-[500px] flex items-center justify-center p-8 text-center text-gray-500">
                <div>
