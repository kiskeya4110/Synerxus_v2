    ...
    return (
      <OrganizationPWALayout activeTab="home">
        <div className="p-4">
          {/* Page Header */}
          <div className="mb-4">
            <h1 className="text-xl font-bold mb-1 text-stone-900">Volunteers</h1>
            <p className="text-sm text-stone-600">Manage volunteer profiles</p>
          </div>
          ...
          {filteredVolunteers.length === 0 && !isLoading && (
            <div className="text-center py-8">
              ...
              <p className="text-stone-600 text-sm">No volunteers found</p>
            </div>
          )}

          {/* Volunteer Insights KPIs */}
          <div className="mt-6 mb-4">
            <h2 className="text-lg font-bold mb-3 flex items-center gap-2 text-stone-900">
